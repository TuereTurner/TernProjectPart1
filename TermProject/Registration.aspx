...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblBadUsername" runat="server" Text="Username already used. Please select another"></asp:Label>
                ...
                <div class="col-10">
                    <div class="dropdown">
                        <asp:DropDownList runat="server" ID="drpTypeOfUser" CssClass="dropbtn">
                            ...
                            <asp:ListItem Value="Cloud Administrator" Cssclass="dropdown-content"></asp:ListItem>
                        </asp:DropDownList>
